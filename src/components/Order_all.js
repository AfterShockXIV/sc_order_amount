          ...
          <table id="example" class="table_w table table-bordered table-striped ">
            ...
            <tbody id="myTable" class="table_w">
              {order_all.map((val, key) => {
                console.log("testval " + val.order11)
                return (
                  <tr>
                 ...
                 {(() => {
                      if (val.order50 == "0") {
                        ...
                        return (
                          <td >{val.order50.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,')}</td>
                        )
                      }
                    })()}
                  {(() => {
                      if (val.order51 == "0") {
                        ...
                        return (
                          <td >{val.order51.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,')}</td>
                        )
                      }
                    })()}
                   {(() => {
                      if (val.order52 == "0") {
                        ...
                        return (
                          <td >{val.order52.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,')}</td>
                        )
                      }
                    })()}
                     {(() => {
                      if (val.order53 == "0") {
                        ...
                        return (
                          <td >{val.order53.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,')}</td>
                        )
                      }
                    })()}
                  {(() => {
                      if (val.order54 == "0") {
                        ...
                        return (
                          <td >{val.order54.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,')}</td>
                        )
                      }
                    })()}
                    <td  >{val.order55}</td>
              ...
              {sum_row.map((val, key) => {
                return (
                  <tr>
                    ...
                    <td style={{ fontSize: 14, color: 'red' }}>{val.sum_row50.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,')}</td>
                    <td style={{ fontSize: 14, color: 'red' }}>{val.sum_row51.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,')}</td>
                    <td style={{ fontSize: 14, color: 'red' }}>{val.sum_row52.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,')}</td>
                    <td style={{ fontSize: 14, color: 'red' }}>{val.sum_row53.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,')}</td>
                    <td style={{ fontSize: 14, color: 'red' }}>{val.sum_row54.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,')}</td>
                    <td style={{ fontSize: 14, color: 'red' }}>{val.sum_row55}</td>
                    <td style={{ fontSize: 14, color: 'red' }}>{val.sum_row56}</td>
                    <td style={{ fontSize: 14, color: 'red' }}>{val.sum_row57}</td>
                    {sum_all.map((val, key) => {
                      return (
                        <td style={{ fontSize: 15, color: 'red' }}>{val.sum_all.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,')}</td>
                      );
                    })}
                  </tr>
                );
